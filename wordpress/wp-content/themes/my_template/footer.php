    ...
    <section class="pb-0">
        ...
        <div class="container">
            ...
            <div class="pre-footer">
                <ul class="list">
                    ...
                    <li class="list-body">
                        ...
                        <a href="#"><strong class="text-primary">Merrouch</strong> <span class="text-dark">Gaming</span></a>
                    </li>
                </ul>
                <ul class="list">
                    <li class="list-head">
            ...
            <!-- foooter -->
            <footer class="footer">            
                <p>Copyright <script>document.write(new Date().getFullYear())</script> &copy; <a target="blank" href="https://github.com/ahmedelbahri">ahelbah</a></p>
